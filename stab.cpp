...
int main(int argc, char **argv)
{
    ...
    while(true) {
        ...
        // Mat mask = Mat::zeros(cur_grey.size(), CV_8U);  // type of mask is CV_8U
        // Mat roi(mask, cv::Rect(100,100,100,100));
        // roi = Scalar(255, 255, 255);

        goodFeaturesToTrack(prev_grey, prev_corner, 10, 0.01, 50);//, mask);
        ...
        Mat T = getPerspectiveTransform(prev_corner2, cur_corner2); // false = rigid transform, no scaling/shearing
